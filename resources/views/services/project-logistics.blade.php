    ...
    <main class="main">
        ...
        <div class="page-title">
            <div class="container d-lg-flex justify-content-between align-items-center">
                <h2 class="mb-2 mb-lg-0" x-text="translations.messages.project_logistics"></h2>
                        ...
                        <div class="service-details-slider swiper init-swiper">
                            ...
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <a href="{{ asset('img/services details/PROJECT LOGISTICS1.webp') }}"
                                        data-gallery="services-project-logistics" class="glightbox preview-link">
                                        <img src="{{ asset('img/services details/PROJECT LOGISTICS1.webp') }}"
                                            class="img-fluid services-img-swipe" alt="PROJECT LOGISTICS1">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{ asset('img/services details/PROJECT LOGISTICS2.webp') }}"
                                        data-gallery="services-project-logistics" class="glightbox preview-link">
                                        <img src="{{ asset('img/services details/PROJECT LOGISTICS2.webp') }}"
                                            class="img-fluid services-img-swipe" alt="PROJECT LOGISTICS2">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{ asset('img/services details/PROJECT LOGISTICS3.webp') }}"
                                        data-gallery="services-project-logistics" class="glightbox preview-link">
                                        <img src="{{ asset('img/services details/PROJECT LOGISTICS3.webp') }}"
                                            class="img-fluid services-img-swipe" alt="PROJECT LOGISTICS3">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{ asset('img/services details/PROJECT LOGISTICS4.webp') }}"
                                        data-gallery="services-project-logistics" class="glightbox preview-link">
                                        <img src="{{ asset('img/services details/PROJECT LOGISTICS4.webp') }}"
