                        ...
                        <div class="service-details-slider swiper init-swiper">
                            ...
                            <div class="swiper-wrapper align-items-center">
                                <div class="swiper-slide">
                                    <a href="{{ asset('img/services details/FREIGHT FORWARDING1.webp') }}"
                                        data-gallery="services-freight-forwarding" class="glightbox preview-link">
                                        <img src="{{ asset('img/services details/FREIGHT FORWARDING1.webp') }}"
                                            class="img-fluid services-img-swipe" alt="FREIGHT FORWARDING1">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{ asset('img/services details/FREIGHT FORWARDING2.webp') }}"
                                        data-gallery="services-freight-forwarding" class="glightbox preview-link">
                                        <img src="{{ asset('img/services details/FREIGHT FORWARDING2.webp') }}"
                                            class="img-fluid services-img-swipe" alt="FREIGHT FORWARDING2">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{ asset('img/services details/FREIGHT FORWARDING3.webp') }}"
                                        data-gallery="services-freight-forwarding" class="glightbox preview-link">
                                        <img src="{{ asset('img/services details/FREIGHT FORWARDING3.webp') }}"
